export const MovesText: {[k: string]: MoveText} = {
	...
	"1000000butterflycascade": {
		desc: "Boosts Special Attack, Special Defense, and Speed 1 stage",
		shortDesc: "Boosts SpA, SpD, Spe +1",
		name: "1,000,000 Butterfly Cascade",
	},
	"1000burningwhips": {
		desc: "If this move is successful, the weather becomes Sunny.",
		shortDesc: "Summons Sunny Weather.",
	...
	alphabeticalorder: {
		...
		desc: "The user is protected from most attacks made by other Pokemon during this turn, and if a Pokemon makes contact with the user, Unown Alphabet has it's Special Attack raise by 2 stages. Non-damaging moves go through this protection. This move has a 1/X chance of being successful, where X starts at 1 and triples each time this move is successfully used. X resets to 1 if this move fails, if the user's last move used is not Alphabetical Order, Baneful Bunker, Detect, Endure, King's Shield, Protect, Quick Guard, Spiky Shield, or Wide Guard, or if it was one of those moves and the user's protection was broken. Fails if the user moves last this turn.",
		shortDesc: "Protects from attacks. Contact: boosts SpA by 2.",
	},
	alphastrike: {
		name: "Alpha Strike",
	...
	barricade: {
		desc: "Lowers the user's Attack, Special Atack, and Speed by 1 stage. Raises the user's Defense and Special Defense by 2 stages.",
		shortDesc: "Lowers Atk, SpA, Spe 1; raises Def, SpD by 2.",
		name: "Barricade",
	},
	barrier: {
		name: "Barrier",
	...
	bountifulforgiveness: {
		desc: "Raises the user's Attack, Defense, Special Attack, Special Defense, and Speed by 1 stage, heals to full.",
		shortDesc: "Raises the user's Atk/Def/SpAtk/SpDef/Spe by 1, heals to full.",
	...
	fairyspell: {
		desc: "Bewtiches the target. This move does not ignore type immunity.",
		shortDesc: "Bewitches the target.",
		name: "Fairy Spell",
	},
	fairywind: {
		name: "Fairy Wind",
	...
	inverseroom: {
		desc: "For 5 turns, the type effectiveness of all moves and Pokemon are reversed.  Weaknesses become resistances, while resistances and immunities become weaknesses. Freeze-Dry does not change its effectiveness.",
		shortDesc: "For 5 turns, all type effectiveness of all moves and Pokemon are reversed.",
		name: "Inverse Room",
	},
	iondeluge: {
		name: "Ion Deluge",
	...
	lavaterrain: {
		name: "Lava Terrain",
		desc: "For 5 turns, the terrain becomes Lava Terrain. During the effect, the power of Water-type attacks used against grounded Pokemon is multiplied by 0.5, and grounded Pokemon have 1/16 of their maximum HP, rounded down, reduced at the end of each turn, including the last turn. Camouflage transforms the user into a Fire type, Nature Power becomes Flamethrower, and Secret Power has a 30% chance to cause burn. Fails if the current terrain is Lava Terrain.",
		shortDesc: "5 turns. 1/16 damage non fire,-Water power vs grounded.",
	},
	leafage: {
		name: "Leafage",
		shortDesc: "No additional effect.",
	...
	maxairstream: {
		name: "Max Airstream",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Speed of each Pokemon on the user's side is raised by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Allies: +1 Speed.",
	},
	maxdarkness: {
		name: "Max Darkness",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Special Defense of each Pokemon on the opposing side is lowered by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Foes: -1 Sp. Def.",
	},
	maxdestruction: {
		name: "Max Destruction",
		shortDesc: "Base move affects power. 20% of the time, starts Maelstrom.",
	},
	maxflare: {
		name: "Max Flare",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Sunny Day begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Sunny Day.",
	},
	maxflutterby: {
		name: "Max Flutterby",
		desc: "Power is equal to the base move's Max Move power. If this move is successful20% of the time, the Special Attack of each Pokemon on the opposing side is lowered by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Foes: -1 Sp. Atk.",
	},
	maxgeyser: {
		name: "Max Geyser",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Rain Dance begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Rain Dance.",
	},
	maxguard: {
		name: "Max Guard",
	...
	maxhailstorm: {
		name: "Max Hailstorm",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Hail begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Hail.",
	},
	maxknuckle: {
		name: "Max Knuckle",
		desc: "Boosts the user and its allies' Attack by 1 stage 20% of the time. BP scales with the base move's BP.",
		shortDesc: "Base move affects power. 20% of the time, Allies: +1 Attack.",
	},
	maxlightning: {
		name: "Max Lightning",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Electric Terrain begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Electric Terrain.",
	},
	maxmindstorm: {
		name: "Max Mindstorm",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Psychic Terrain begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Psychic Terrain.",
	},
	maxooze: {
		name: "Max Ooze",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Special Attack of each Pokemon on the user's side is raised by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Allies: +1 Sp. Atk.",
	},
	maxovergrowth: {
		name: "Max Overgrowth",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Grassy Terrain begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Grassy Terrain.",
	},
	maxphantasm: {
		name: "Max Phantasm",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Defense of each Pokemon on the opposing side is lowered by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Foes: -1 Defense.",
	},
	maxquake: {
		name: "Max Quake",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Special Defense of each Pokemon on the user's side is raised by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Allies: +1 Sp. Def.",
	},
	maxrockfall: {
		name: "Max Rockfall",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Sandstorm begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Sandstorm.",
	},
	maxstarfall: {
		name: "Max Starfall",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the effect of Misty Terrain begins.",
		shortDesc: "Base move affects power. 20% of the time, starts Misty Terrain.",
	},
	maxsteelspike: {
		name: "Max Steelspike",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Defense of each Pokemon on the user's side is raised by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Allies: +1 Defense.",
	},
	maxstrike: {
		name: "Max Strike",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Speed of each Pokemon on the opposing side is lowered by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Foes: -1 Speed.",
	},
	maxwyrmwind: {
		name: "Max Wyrmwind",
		desc: "Power is equal to the base move's Max Move power. If this move is successful 20% of the time, the Attack of each Pokemon on the opposing side is lowered by 1 stage, even if they have a substitute.",
		shortDesc: "Base move affects power. 20% of the time, Foes: -1 Attack.",
	},
	meanlook: {
		name: "Mean Look",
		desc: "Prevents target from switching for the next three turns. A Pokemon can still switch out if it is holding Shed Shell or uses Baton Pass, Parting Shot, U-turn, or Volt Switch. Fails if the effect is already active.",
	...
	psychokinesis: {
		shortDesc: "After damaging the foe, the next move is assured to hit.",
		name: "Psychokinesis",
	},
	psychoshift: {
		name: "Psycho Shift",
	...
	reconstruction: {
		desc: "The user restores 1/4 of its maximum HP, rounded half up.  For each positive and negative boost, it heals an additional 1/20th.  Then it clears all its boosts.",
		shortDesc: "Heals 25% + 5% for every +/- boost, clears boosts.",
		name: "Reconstruction",
	},
	recover: {
		name: "Recover",
	...
	revealingjudgment: {
		...
		desc: "The user restores 1/3 of its maximum HP, rounded half up, unless also hit by an attack, in which it heals an additional 1/3.",
		shortDesc: "Heals the user by 33% of its max HP, unless hit which adds another 33%.",
	},
	revelationdance: {
